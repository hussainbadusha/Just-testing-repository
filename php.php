...
if(isset($_SESSION[SESSION_LOGIN_STATUS])){ 
	echo "<script>location.href = '" . PROFILE . "'</script>"; exit;
}
echo "<script>location.href='" . SIGNIN . "'</script>"; exit;
$themeFolder	= TP_INTEGRATION . '/' . THEME_NAME . '/';
?>
<!doctype html>
<html>
<head>
...
<title>Automiz</title>
<link rel="icon" href="<?php echo $themeFolder; ?>favicon.png" type="image/png">
<link href="<?php echo $themeFolder; ?>css/bootstrap.min.css?s" rel="stylesheet" type="text/css">
<link href="<?php echo $themeFolder; ?>css/style.css?s" rel="stylesheet" type="text/css"> 
<link href="<?php echo $themeFolder; ?>css/font-awesome.css?s" rel="stylesheet" type="text/css"> 
<link href="<?php echo $themeFolder; ?>css/animate.css?s" rel="stylesheet" type="text/css">
 
<!--[if lt IE 9]>
    <script src="<?php echo $themeFolder; ?>js/respond-1.1.0.min.js"></script>
    <script src="<?php echo $themeFolder; ?>js/html5shiv.js"></script>
    <script src="<?php echo $themeFolder; ?>js/html5element.js"></script>
<![endif]-->
...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img style="width: 60%;" src="<?php echo $themeFolder; ?>img/logo.png" alt="logo"></a></div>
      ...
      <div class="navbar-header">
	    ...
	    <div id="main-nav" class="collapse navbar-collapse navStyle">
			<ul class="nav navbar-nav" id="mainNav">
			  ...
			  <li><a href="<?php echo PROJECT_DIR . SIGNUP; ?>" class="scroll-link">Signup</a></li>
			  <li><a href="<?php echo PROJECT_DIR . SIGNIN; ?>" class="scroll-link">Login</a></li>
			</ul>
      </div>
	 </nav>
    </div>
      ...
      <div class="hero_section">
        <div class="row">
          ...
          <div class="col-lg-7 col-sm-5">
			<img src="<?php echo $themeFolder; ?>img/main_device_image.png" class="zoomIn wow animated" alt="" />
		  </div>
        </div>
      </div>
    </div>
...
<div class="inner_wrapper">
  <div class="container">
	...
	<div class="row">
      <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="<?php echo $themeFolder; ?>img/about-img.jpg" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
  ...
  <div class="portfolio"> 
    ...
    <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   appleIOS isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic1.jpg"  alt="Portfolio 1"> </div>        
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic2.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design  isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic3.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  android  prototype web isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic4.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic5.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic6.jpg" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic7.jpg" alt="Portfolio 1"> </div>       
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   android isotope-item">
        <div class="portfolio_img"> <img src="<?php echo $themeFolder; ?>img/portfolio_pic8.jpg" alt="Portfolio 1"> </div>       
        <div class="item_overlay">
          <div class="item_info"> 
...
<div class="client_logos"><!--client_logos-->
  <div class="container">
    <ul class="fadeInRight animated wow">
      <li><a href="javascript:void(0)"><img src="<?php echo $themeFolder; ?>img/client_logo1.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="<?php echo $themeFolder; ?>img/client_logo2.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="<?php echo $themeFolder; ?>img/client_logo3.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="<?php echo $themeFolder; ?>img/client_logo5.png" alt=""></a></li>
    </ul>
  </div>
</div>
</section>
    ...
    <div class="team_section clearfix">
      <div class="team_area">
        <div class="team_box wow fadeInDown delay-03s">
          ...
          <img src="<?php echo $themeFolder; ?>img/team_pic1.png" alt="">
          <ul>
        ...
        <h3 class="wow fadeInDown delay-03s">Hussain Badusha</h3>
      ...
      <div class="team_area">
        <div class="team_box  wow fadeInDown delay-06s">
          <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
          <img src="<?php echo $themeFolder; ?>img/team_pic2.png" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
        ...
        <h3 class="wow fadeInDown delay-06s">Mohideen Badusha</h3>
      ...
      <div class="team_area">
        <div class="team_box wow fadeInDown delay-09s">
          <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
          <img src="<?php echo $themeFolder; ?>img/team_pic3.png" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
        ...
        <h3 class="wow fadeInDown delay-09s">Mohideen Hussain</h3>
...
<footer class="footer_wrapper" id="contact">
      ...
      <div class="row">
        <div class="col-lg-4 wow fadeInLeft">	
		 <div class="contact_info">
			<div class="detail">
				<h4><?php echo OUR_COMPANY . ', Inc'; ?></h4>
				<p>First Floor, Annai Aravindar Building,<br/>
				(Near Aravindh Hospital),<br/>
				Tirunelveli Junction,Tamil	Nadu <br/>
				627001, India</p>
			</div>
			<div class="detail">
				<h4>Call us</h4>
				<p>+1 (718) 473-0774<br/>+91 (462) 456-4010</p>
			</div>
			<div class="detail">
				<h4>Email us</h4>
				<p>support@automiz.com</p>
			</div> 
		</div>		  
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright &copy; 2015 Automiz </span> </div>
  </div>
</footer>

<script type="text/javascript" src="<?php echo $themeFolder; ?>js/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/jquery-scrolltofixed.js"></script>
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/jquery.nav.js"></script> 
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/jquery.isotope.js"></script>
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/wow.js"></script> 
<script type="text/javascript" src="<?php echo $themeFolder; ?>js/custom.js"></script>
